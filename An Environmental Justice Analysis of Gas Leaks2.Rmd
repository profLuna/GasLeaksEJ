...
```{r MAUP, fig.align = "center", fig.cap="Comparison of scales and units of analysis: municiplaity (i.e., Census County Subdivision), Census Tract, and Census Block Group", echo=FALSE, message=FALSE, cache=TRUE}
...
#   tm_layout(title = "Municipality (i.e., County\nSubdivision)", 
...
#   # tm_shape(ma_blkgrp_4) + tm_fill(col = "#1b9e77") +
#   tm_shape(ma_cosub) + tm_borders(col = "#7570b3", lwd = 3) +
#   tm_credits("Tract", position = c(0.49,0.27)) +
...
#             inner.margins = c(0.01,0.02,0.04,0.02))
# 
...
```{r mapTimeCO, fig.align='center', fig.cap= "Average repair times for leaks repaired in 2019 across Massachuseetts by municipality", cache=TRUE}
...
```{r magCOage, fig.align='center', fig.cap= "Average unrepaired leak age in 2019 across Massachuseetts by municipality", cache=TRUE}
...
```{r figDotAge, fig.align='center', fig.cap="Relative exposure to population-weighted mean gas leak age of unrepaired leaks in 2019 at Census Block Group, Census Tract, and municipality scales"}
