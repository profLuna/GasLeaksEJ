...
unrepaired2019_with_blkgrp <- ma_blkgrps %>% 
  select(GEOID) %>%
  st_join(unrepaired2019final, ., largest = TRUE)
# do same for repaired leaks
repaired2019_with_blkgrp <- ma_blkgrps %>% 
  select(GEOID) %>%
...
ma_blkgrps <- lapply(list(unrepaired2019_by_blkgrp,
...
# join total leak counts to the block group demographics
ma_blkgrps <- lapply(list(repaired2019_by_blkgrp,
...
saveRDS(ma_blkgrps, file = "Data/ma_blkgrpsMEAN.Rds")

# load output
ma_blkgrps <- readRDS("Data/ma_blkgrpsMEAN.Rds")

# look at summary statistics and distributions of values
nrow(repaired2019final)/(nrow(unrepaired2019final) + nrow(repaired2019final))
table(unrepaired2019final$Class)
table(repaired2019final$Class)

summary(ma_blkgrps$leaks_sqkm)
ma_blkgrps %>% 
  ggplot(aes(x = leaks_sqkm)) + geom_histogram()

# test for normality. definitely not normal!
shapiro.test(ma_blkgrps$leaks_sqkm)


### TESTS FOR STATISITCALLY SIGNIFICANT DIFFERENCES 
...
# 
# summary(ma_blkgrps$unrepaired2019total)
# 
# tm_shape(ma_blkgrps) + tm_fill(col = "unrepaired2019total", style = "fisher")
# 
# ma_blkgrps %>%
#   ggplot(aes(x = leaks_sqkm)) + geom_histogram()
# 
# summary(ma_blkgrps$leaks_sqkm)
# 
# tm_shape(ma_blkgrps) + tm_fill(col = "leaks_sqkm", style = "quantile")
# tm_shape(ma_blkgrps) + tm_fill(col = "leaks_sqkm", style = "fisher") + 
...
# 
# summary(ma_blkgrps$unrepaired2019totalC1)
# 
# ma_blkgrps %>% 
#   ggplot(aes(x = unrepaired2019totalC2)) + geom_histogram()
# 
# summary(ma_blkgrps$unrepaired2019totalC2)
# 
# ma_blkgrps %>% 
#   ggplot(aes(x = unrepaired2019totalC3)) + geom_histogram()
# 
# summary(ma_blkgrps$unrepaired2019totalC3)
...
saveRDS(ppLeakDensityJoined, file = "Data/ppLeakDensityAVG.Rds")
...
# save object
saveRDS(ppLeakDensity_df, file = "Data/ppLeakDensity_df_blkgrps.Rds")
...
ggsave("Images/LeaksPPbyClassRR_blkgrp.png")
...
ppLeakDensity_df %>% 
  ...
  kable(longtable = T, booktabs = T,
        format.args = list(big.mark = ','), 
        caption = "Population-weighted mean leak density (leaks/sqkm) of repaired leaks in 2019.", align = "r", digits = c(0,1,1,2,1,2,1,2,1), 
        col.names = c("Group","Per SqKm","RR","Per SqKm","RR",
                      "Per SqKm","RR","Per SqKm","RR")) %>% 
...
ggsave("Images/LeaksPPbyClassREPRR_blkgrp.png")
...
ggsave("Images/LeaksPPbyClassAllRR_blkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_RR_blkgrp.png")
...
ppLeakDensity_df %>% 
  ...
  facet_wrap(~ leakClass, scales = "free") +
  labs(x = NULL, 
       y = "Population-weighted mean repaired leaks per occupied housing unit by Census Block Group",
...
ggsave("Images/LeaksPPbyClassREP_HU_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_blkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_RR_blkgrp.png")
...
# save output
saveRDS(ppLeakDensityJoinedU, file = "Data/ppLeakDensityJoinedU_BG.Rds")
...
ggsave("Images/LeaksPPbyUtilityRR_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtility_HU_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtility_HU_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtilityREP_RR_blkgrp.png")
...
ppLeakDensityJoinedU %>% 
  ...
  facet_wrap(~ Utility, scales = "free") +
  labs(x = NULL, 
       y = "Population-weighted mean of repaired leaks per occupied housing unit by Census Block Group",
       title = "Piority Populations and Repaired Gas Leaks Per Occupied Housing Unit by Utility for 2019")

ggsave("Images/LeaksPPbyUtilityREP_HU_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtilityREP_HU_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtilityAll_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtilityAll_HU_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtilityAge_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtilityAge_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyUtilityTime_RR_blkgrp.png")
...
ggsave("Images/LeaksPPbyClass_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassRR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREPRR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAllRR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_RR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_RR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_RR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_RR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_RR_NGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassRR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREPRR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAllRR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_RR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_RR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_RR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_RR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_RR_EVblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassRR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREPRR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAllRR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_RR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_RR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_RR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_RR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_RR_CGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassRR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREPRR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAllRR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_RR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_RR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_RR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_RR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_RR_LUblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassRR_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREPRR_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAllRR_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClass_HU_RR_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_RR_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_RR_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassTime_RR_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_BGblkgrp.png")
...
ggsave("Images/LeaksPPbyClassAge_RR_BGblkgrp.png")



### Look at typical stats: 
# number of unrepaired, repaired, and total leaks
nrow(unrepaired2019final)
nrow(repaired2019final)
nrow(unrepaired2019final) + nrow(repaired2019final)
# number of leaks by class
table(unrepaired2019final$Class)
table(repaired2019final$Class)
...
total_Sumdf <- left_join(unrepaired_Sumdf, repaired_Sumdf, by = "Class") %>% 
  ...
  select(Class, Unrepaired, PctUnrepaired, Repaired, PctRepaired, Total, PctTotal)
total_Sumdf
...
# tabulate avg age of all unrepaired leaks
ageAll <- unrepaired2019final %>% 
  as.data.frame() %>% 
...
# tabulate avg repair time for repaired leaks
repaired2019final %>% 
  as.data.frame() %>% 
  group_by(Class) %>% 
  summarize(across(.cols = DaysToRepair, summary_stats, 
...
df <- ma_blkgrps %>% 
  ...
  select(totalpopE, nhwhitepop_E, nhblackpop_E, hisppop_E, nhasianpop_E, 
         ...
         renter_occ_unitsE, total_occ_unitsE, householdsE, 
         MA_INCOME21, MA_MINORITY21, MA_ENGLISH,
  ...
  mutate(MA_INCOME21 = if_else(MA_INCOME21 == "I", totalpopE, 0),
         MA_MINORITY21 = if_else(MA_MINORITY21 == "M", totalpopE,0),
         MA_ENGLISH = if_else(MA_ENGLISH == "E", totalpopE,0)) %>% 
  mutate(across(.cols = starts_with("MA_"), ~replace_na(.x, 0)))

# pivot df to long format so that so new df = #groups x #rows
dfp <- df %>% 
  select(-c(renter_occ_unitsE:householdsE)) %>% 
  pivot_longer(., cols = totalpopE:MA_ENGLISH, 
                    names_to = "group", values_to = "pop") %>% 
  mutate(group = as.factor(group))

# repeat for OHU
dfpOHU <- df %>% 
  select(renter_occ_unitsE,total_occ_unitsE,
         c(AllLeaks2019_sqkm:DaysToRepairAvgC3)) %>% 
  pivot_longer(., cols = c(renter_occ_unitsE,total_occ_unitsE), 
               names_to = "group", values_to = "pop") %>% 
  mutate(group = as.factor(group))
...
(pwdt_leaks_sqkm %>% 
  ...
  rbind(pwdt_OHU_leaks_sqkm) %>% 
  arrange(statistic) %>% 
  write_csv("Tables/BG/pwdt_leaks_sqkm.csv"))
...
(pwdt_leaks_sqkmC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
  rbind(pwdt_OHU_leaks_sqkmC1) %>% 
  arrange(statistic) %>% 
  write_csv("Tables/BG/pwdt_leaks_sqkmC1.csv"))
...
(pwdt_leaks_sqkmC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
  rbind(pwdt_OHU_leaks_sqkmC2) %>% 
  arrange(statistic) %>% 
  write_csv("Tables/BG/pwdt_leaks_sqkmC2.csv"))
...
(pwdt_leaks_sqkmC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_leaks_sqkmC3.csv"))
...
(pwdt_REPleaks_sqkm %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkm) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_sqkm.csv"))
...
(pwdt_REPleaks_sqkmC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_sqkmC1.csv"))
...
(pwdt_REPleaks_sqkmC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_sqkmC2.csv"))
...
(pwdt_REPleaks_sqkmC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_sqkmC3.csv"))
...
(pwdt_leaks_hu %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_hu) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_leaks_hu.csv"))
...
(pwdt_leaks_huC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_leaks_huC1.csv"))
...
(pwdt_leaks_huC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_leaks_huC2.csv"))
...
(pwdt_leaks_huC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_leaks_huC3.csv"))
...
(pwdt_REPleaks_hu %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_hu) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_hu.csv"))
...
(pwdt_REPleaks_huC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_huC1.csv"))
...
(pwdt_REPleaks_huC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_huC2.csv"))
...
(pwdt_REPleaks_huC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_REPleaks_huC3.csv"))
...
(pwdt_DaysToRepairAvg %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvg) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_DaysToRepairAvg.csv"))
...
(pwdt_DaysToRepairAvgC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_DaysToRepairAvgC1.csv"))
...
(pwdt_DaysToRepairAvgC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_DaysToRepairAvgC2.csv"))
...
(pwdt_DaysToRepairAvgC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_DaysToRepairAvgC3.csv"))
...
(pwdt_LeakAgeDaysAvg %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvg) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_LeakAgeDaysAvg.csv"))
...
(pwdt_LeakAgeDaysAvgC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_LeakAgeDaysAvgC1.csv"))
...
(pwdt_LeakAgeDaysAvgC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_LeakAgeDaysAvgC2.csv"))
...
(pwdt_LeakAgeDaysAvgC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/pwdt_LeakAgeDaysAvgC3.csv"))
...
####### Look at stats by utility
unrepairedUSum_df <- unrepaired2019final %>% 
  as.data.frame() %>% 
...
repairedUSum_df <- repaired2019final %>% 
  as.data.frame() %>% 
  mutate(Utility = recode(Utility, 
                          "National Grid - Colonial Gas" = "National Grid",
                          "National Grid - Boston Gas" = "National Grid")) %>% 
...
ggsave("Images/LeaksbyUtility.png")

# Is pct repaired related to total number of leaks?
totalUSum_df %>% ggplot(aes(x = Total, y = PctUnrepaired)) + geom_point()
cor.test(x = total_Sumdf$Total, y = total_Sumdf$PctUnrepaired, method = "spearman")

# look at leak age per utility
# stats on all leaks per utility
unrepaired2019final %>% 
  as.data.frame() %>% 
  mutate(Utility = recode(Utility, 
                          "National Grid - Colonial Gas" = "National Grid",
  ...
  summarize(across(.cols = LeakAgeDays, summary_stats, 
                   .names = "{.fn}"))
# stats on class 1 leaks per utility
unrepaired2019final %>% 
  as.data.frame() %>% 
  mutate(Utility = recode(Utility, 
                          "National Grid - Colonial Gas" = "National Grid",
...
# stats on class 3 leaks per utility
unrepaired2019final %>% 
  as.data.frame() %>% 
  mutate(Utility = recode(Utility, 
                          "National Grid - Colonial Gas" = "National Grid",
...
(pwdt_leaks_sqkmNG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmNG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_sqkmNG.csv"))
...
(pwdt_leaks_sqkmNGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmNGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_sqkmNGC1.csv"))
...
(pwdt_leaks_sqkmNGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmNGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_sqkmNGC2.csv"))
...
(pwdt_leaks_sqkmNGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmNGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_sqkmNGC3.csv"))
...
(pwdt_REPleaks_sqkmNG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmNG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_sqkmNG.csv"))
...
(pwdt_REPleaks_sqkmNGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmNGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_sqkmNGC1.csv"))
...
(pwdt_REPleaks_sqkmNGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmNGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_sqkmNGC2.csv"))
...
(pwdt_REPleaks_sqkmNGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmNGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_sqkmNGC3.csv"))
...
(pwdt_leaks_huNG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huNG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_huNG.csv"))
...
(pwdt_leaks_huNGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huNGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_huNGC1.csv"))
...
(pwdt_leaks_huNGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huNGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_huNGC2.csv"))
...
(pwdt_leaks_huNGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huNGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_leaks_huNGC3.csv"))
...
(pwdt_REPleaks_huNG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huNG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_huNG.csv"))
...
(pwdt_REPleaks_huNGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huNGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_huNGC1.csv"))
...
(pwdt_REPleaks_huNGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huNGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_huNGC2.csv"))
...
(pwdt_REPleaks_huNGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huNGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_REPleaks_huNGC3.csv"))
...
(pwdt_DaysToRepairAvgNG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgNG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_DaysToRepairAvgNG.csv"))
...
(pwdt_DaysToRepairAvgNGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgNGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_DaysToRepairAvgNGC1.csv"))
...
(pwdt_DaysToRepairAvgNGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgNGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_DaysToRepairAvgNGC2.csv"))
...
(pwdt_DaysToRepairAvgNGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgNGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_DaysToRepairAvgNGC3.csv"))
...
(pwdt_LeakAgeDaysAvgNG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgNG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_LeakAgeDaysAvgNG.csv"))
...
(pwdt_LeakAgeDaysAvgNGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgNGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_LeakAgeDaysAvgNGC1.csv"))
...
(pwdt_LeakAgeDaysAvgNGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgNGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_LeakAgeDaysAvgNGC2.csv"))
...
(pwdt_LeakAgeDaysAvgNGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgNGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/NG/pwdt_LeakAgeDaysAvgNGC3.csv"))
...
ppLeakDensityEV <- ma_blkgrps %>% 
  ...
  select(totalpopE, nhwhitepop_E, nhblackpop_E, hisppop_E, nhasianpop_E, 
         minority_E, eng_limitE, num2povE, lthsE, under5E, over64E,
         renter_occ_unitsE, total_occ_unitsE, householdsE, 
         MA_INCOME21, MA_MINORITY21, MA_ENGLISH, (starts_with("leaks_") & (ends_with("EV") | ends_with("EVC1") | ends_with("EVC2") | ends_with("EVC3"))), 
         (starts_with("AllLeaks") & (ends_with("EV") | ends_with("EVC1") | ends_with("EVC2") | ends_with("EVC3"))), 
         (starts_with("LeakAgeDaysAvg") & (ends_with("EV") | ends_with("EVC1") | ends_with("EVC2") | ends_with("EVC3"))),
         (starts_with("REPleaks_") & (ends_with("EV") | ends_with("EVC1") | ends_with("EVC2") | ends_with("EVC3"))), 
         (starts_with("DaystoRepairAvg") & (ends_with("EV") | ends_with("EVC1") | ends_with("EVC2") | ends_with("EVC3"))), 
...
(pwdt_leaks_sqkmEV %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>%
    rbind(pwdt_OHU_leaks_sqkmEV) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_leaks_sqkmEV.csv"))
...
# (pwdt_leaks_sqkmEVC1 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_sqkmEVC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/EV/pwdt_leaks_sqkmEVC1.csv"))
...
(pwdt_leaks_sqkmEVC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmEVC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_leaks_sqkmEVC2.csv"))
...
(pwdt_leaks_sqkmEVC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmEVC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_leaks_sqkmEVC3.csv"))
...
(pwdt_REPleaks_sqkmEV %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmEV) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_REPleaks_sqkmEV.csv"))
...
(pwdt_REPleaks_sqkmEVC1 %>%
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>%
    rbind(pwdt_OHU_REPleaks_sqkmEVC1) %>%
    arrange(statistic) %>%
    write_csv("Tables/BG/EV/pwdt_REPleaks_sqkmEVC1.csv"))
...
(pwdt_REPleaks_sqkmEVC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmEVC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_REPleaks_sqkmEVC2.csv"))
...
(pwdt_REPleaks_sqkmEVC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmEVC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_REPleaks_sqkmEVC3.csv"))
...
(pwdt_leaks_huEV %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huEV) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_leaks_huEV.csv"))
...
# (pwdt_leaks_huEVC1 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_huEVC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/EV/pwdt_leaks_huEVC1.csv"))
...
(pwdt_leaks_huEVC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huEVC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_leaks_huEVC2.csv"))
...
(pwdt_leaks_huEVC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huEVC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_leaks_huEVC3.csv"))
...
(pwdt_REPleaks_huEV %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huEV) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_REPleaks_huEV.csv"))
...
(pwdt_REPleaks_huEVC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huEVC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_REPleaks_huEVC1.csv"))
...
(pwdt_REPleaks_huEVC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huEVC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_REPleaks_huEVC2.csv"))
...
(pwdt_REPleaks_huEVC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huEVC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_REPleaks_huEVC3.csv"))
...
(pwdt_DaysToRepairAvgEV %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgEV) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_DaysToRepairAvgEV.csv"))
...
(pwdt_DaysToRepairAvgEVC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgEVC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_DaysToRepairAvgEVC1.csv"))
...
(pwdt_DaysToRepairAvgEVC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgEVC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_DaysToRepairAvgEVC2.csv"))
...
(pwdt_DaysToRepairAvgEVC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgEVC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_DaysToRepairAvgEVC3.csv"))
...
(pwdt_LeakAgeDaysAvgEV %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgEV) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_LeakAgeDaysAvgEV.csv"))
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_LeakAgeDaysAvgEVC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/EV/pwdt_LeakAgeDaysAvgEVC1.csv"))
...
(pwdt_LeakAgeDaysAvgEVC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgEVC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_LeakAgeDaysAvgEVC2.csv"))
...
(pwdt_LeakAgeDaysAvgEVC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgEVC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/EV/pwdt_LeakAgeDaysAvgEVC3.csv"))
...
ppLeakDensityCG <- ma_blkgrps %>% 
  ...
  select(totalpopE, nhwhitepop_E, nhblackpop_E, hisppop_E, nhasianpop_E, 
         minority_E, eng_limitE, num2povE, lthsE, under5E, over64E,
         renter_occ_unitsE, total_occ_unitsE, householdsE, 
         MA_INCOME21, MA_MINORITY21, MA_ENGLISH, (starts_with("leaks_") & (ends_with("CG") | ends_with("CGC1") | ends_with("CGC2") | ends_with("CGC3"))), 
         (starts_with("AllLeaks") & (ends_with("CG") | ends_with("CGC1") | ends_with("CGC2") | ends_with("CGC3"))), 
         (starts_with("LeakAgeDaysAvg") & (ends_with("CG") | ends_with("CGC1") | ends_with("CGC2") | ends_with("CGC3"))),
         (starts_with("REPleaks_") & (ends_with("CG") | ends_with("CGC1") | ends_with("CGC2") | ends_with("CGC3"))), 
         (starts_with("DaystoRepairAvg") & (ends_with("CG") | ends_with("CGC1") | ends_with("CGC2") | ends_with("CGC3"))), 
...
dfpW %>% 
  group_by(group) %>% 
  rstatix::get_summary_stats(LeakAgeDaysAvgCGC2, type = "common") %>% 
  arrange(desc(median))
...
(pwdt_leaks_sqkmCG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmCG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_sqkmCG.csv"))
...
(pwdt_leaks_sqkmCGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmCGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_sqkmCGC1.csv"))
...
(pwdt_leaks_sqkmCGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmCGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_sqkmCGC2.csv"))
...
(pwdt_leaks_sqkmCGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmCGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_sqkmCGC3.csv"))
...
(pwdt_REPleaks_sqkmCG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmCG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_sqkmCG.csv"))
...
(pwdt_REPleaks_sqkmCGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmCGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_sqkmCGC1.csv"))
...
(pwdt_REPleaks_sqkmCGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmCGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_sqkmCGC2.csv"))
...
(pwdt_REPleaks_sqkmCGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmCGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_sqkmCGC3.csv"))
...
(pwdt_leaks_huCG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huCG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_huCG.csv"))
...
(pwdt_leaks_huCGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huCGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_huCGC1.csv"))
...
(pwdt_leaks_huCGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huCGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_huCGC2.csv"))
...
(pwdt_leaks_huCGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huCGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_leaks_huCGC3.csv"))
...
(pwdt_REPleaks_huCG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huCG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_huCG.csv"))
...
(pwdt_REPleaks_huCGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huCGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_huCGC1.csv"))
...
(pwdt_REPleaks_huCGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huCGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_huCGC2.csv"))
...
(pwdt_REPleaks_huCGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huCGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_REPleaks_huCGC3.csv"))
...
(pwdt_DaysToRepairAvgCG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgCG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_DaysToRepairAvgCG.csv"))
...
(pwdt_DaysToRepairAvgCGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgCGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_DaysToRepairAvgCGC1.csv"))
...
(pwdt_DaysToRepairAvgCGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgCGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_DaysToRepairAvgCGC2.csv"))
...
(pwdt_DaysToRepairAvgCGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgCGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_DaysToRepairAvgCGC3.csv"))
...
(pwdt_LeakAgeDaysAvgCG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgCG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_LeakAgeDaysAvgCG.csv"))
...
#     filter(group2 == "totalpopE" | 
#              (group2 == "under5E" & group1 == "totalpopE")) %>% 
#     rbind(pwdt_OHU_LeakAgeDaysAvgCGC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/CG/pwdt_LeakAgeDaysAvgCGC1.csv"))
...
(pwdt_LeakAgeDaysAvgCGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgCGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_LeakAgeDaysAvgCGC2.csv"))
...
(pwdt_LeakAgeDaysAvgCGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgCGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/CG/pwdt_LeakAgeDaysAvgCGC3.csv"))
...
ppLeakDensityFG <- ma_blkgrps %>% 
  ...
  select(totalpopE, nhwhitepop_E, nhblackpop_E, hisppop_E, nhasianpop_E, 
         minority_E, eng_limitE, num2povE, lthsE, under5E, over64E,
         renter_occ_unitsE, total_occ_unitsE, householdsE, 
         MA_INCOME21, MA_MINORITY21, MA_ENGLISH, (starts_with("leaks_") & (ends_with("FG") | ends_with("FGC1") | ends_with("FGC2") | ends_with("FGC3"))), 
         (starts_with("AllLeaks") & (ends_with("FG") | ends_with("FGC1") | ends_with("FGC2") | ends_with("FGC3"))), 
         (starts_with("LeakAgeDaysAvg") & (ends_with("FG") | ends_with("FGC1") | ends_with("FGC2") | ends_with("FGC3"))),
         (starts_with("REPleaks_") & (ends_with("FG") | ends_with("FGC1") | ends_with("FGC2") | ends_with("FGC3"))), 
         (starts_with("DaystoRepairAvg") & (ends_with("FG") | ends_with("FGC1") | ends_with("FGC2") | ends_with("FGC3"))), 
...
(pwdt_leaks_sqkmFG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmFG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/FG/pwdt_leaks_sqkmFG.csv"))
...
# (pwdt_leaks_sqkmFGC1 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_sqkmFGC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_leaks_sqkmFGC1.csv"))
# 
# # C2 unrepaired leaks per sqkm
...
# (pwdt_leaks_sqkmFGC2 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_sqkmFGC2) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_leaks_sqkmFGC2.csv"))
# 
# # C3 unrepaired leaks per sqkm
...
# (pwdt_leaks_sqkmFGC3 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_sqkmFGC3) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_leaks_sqkmFGC3.csv"))
...
(pwdt_REPleaks_sqkmFG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmFG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/FG/pwdt_REPleaks_sqkmFG.csv"))
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_REPleaks_sqkmFGC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_REPleaks_sqkmFGC1.csv"))
# 
# # C2 repaired leaks per sqkm
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_REPleaks_sqkmFGC2) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_REPleaks_sqkmFGC2.csv"))
# 
# # C3 repaired leaks per sqkm
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_REPleaks_sqkmFGC3) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_REPleaks_sqkmFGC3.csv"))
...
(pwdt_leaks_huFG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huFG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/FG/pwdt_leaks_huFG.csv"))
...
# (pwdt_leaks_huFGC1 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_huFGC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_leaks_huFGC1.csv"))
# 
# # C2 unrepaired leaks per OHU
...
# (pwdt_leaks_huFGC2 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_huFGC2) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_leaks_huFGC2.csv"))
# 
# # C3 unrepaired leaks per OHU
...
# (pwdt_leaks_huFGC3 %>% 
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_leaks_huFGC3) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_leaks_huFGC3.csv"))
...
(pwdt_REPleaks_huFG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huFG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/FG/pwdt_REPleaks_huFG.csv"))
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_REPleaks_huFGC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_REPleaks_huFGC1.csv"))
# 
# # C2 repaired leaks per OHU
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_REPleaks_huFGC2) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_REPleaks_huFGC2.csv"))
# 
# # C3 repaired leaks per OHU
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_REPleaks_huFGC3) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_REPleaks_huFGC3.csv"))
...
(pwdt_DaysToRepairAvgFG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgFG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/FG/pwdt_DaysToRepairAvgFG.csv"))
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_DaysToRepairAvgFGC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_DaysToRepairAvgFGC1.csv"))
# 
# # C2 days to repair avg
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_DaysToRepairAvgFGC2) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_DaysToRepairAvgFGC2.csv"))
# 
# # C3 days to repair avg
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_DaysToRepairAvgFGC3) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_DaysToRepairAvgFGC3.csv"))
...
(pwdt_LeakAgeDaysAvgFG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgFG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/FG/pwdt_LeakAgeDaysAvgFG.csv"))
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_LeakAgeDaysAvgFGC1) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_LeakAgeDaysAvgFGC1.csv"))
# 
# # C2 leak age days avg
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_LeakAgeDaysAvgFGC2) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_LeakAgeDaysAvgFGC2.csv"))
# 
# # C3 leak age days avg
...
#     filter(group2 == "totalpopE") %>% 
#     rbind(pwdt_OHU_LeakAgeDaysAvgFGC3) %>% 
#     arrange(statistic) %>% 
#     write_csv("Tables/BG/FG/pwdt_LeakAgeDaysAvgFGC3.csv"))
...
ppLeakDensityLU <- ma_blkgrps %>% 
  ...
  select(totalpopE, nhwhitepop_E, nhblackpop_E, hisppop_E, nhasianpop_E, 
         minority_E, eng_limitE, num2povE, lthsE, under5E, over64E,
         renter_occ_unitsE, total_occ_unitsE, householdsE, 
         MA_INCOME21, MA_MINORITY21, MA_ENGLISH, (starts_with("leaks_") & (ends_with("LU") | ends_with("LUC1") | ends_with("LUC2") | ends_with("LUC3"))), 
         (starts_with("AllLeaks") & (ends_with("LU") | ends_with("LUC1") | ends_with("LUC2") | ends_with("LUC3"))), 
         (starts_with("LeakAgeDaysAvg") & (ends_with("LU") | ends_with("LUC1") | ends_with("LUC2") | ends_with("LUC3"))),
         (starts_with("REPleaks_") & (ends_with("LU") | ends_with("LUC1") | ends_with("LUC2") | ends_with("LUC3"))), 
         (starts_with("DaystoRepairAvg") & (ends_with("LU") | ends_with("LUC1") | ends_with("LUC2") | ends_with("LUC3"))), 
...
(pwdt_leaks_sqkmLU %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmLU) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_sqkmLU.csv"))
...
(pwdt_leaks_sqkmLUC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmLUC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_sqkmLUC1.csv"))
...
(pwdt_leaks_sqkmLUC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmLUC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_sqkmLUC2.csv"))
...
(pwdt_leaks_sqkmLUC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmLUC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_sqkmLUC3.csv"))
...
(pwdt_REPleaks_sqkmLU %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmLU) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_sqkmLU.csv"))
...
(pwdt_REPleaks_sqkmLUC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmLUC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_sqkmLUC1.csv"))
...
(pwdt_REPleaks_sqkmLUC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmLUC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_sqkmLUC2.csv"))
...
(pwdt_REPleaks_sqkmLUC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmLUC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_sqkmLUC3.csv"))
...
(pwdt_leaks_huLU %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huLU) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_huLU.csv"))
...
(pwdt_leaks_huLUC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huLUC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_huLUC1.csv"))
...
(pwdt_leaks_huLUC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huLUC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_huLUC2.csv"))
...
(pwdt_leaks_huLUC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huLUC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_leaks_huLUC3.csv"))
...
(pwdt_REPleaks_huLU %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huLU) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_huLU.csv"))
...
(pwdt_REPleaks_huLUC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huLUC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_huLUC1.csv"))
...
(pwdt_REPleaks_huLUC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huLUC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_huLUC2.csv"))
...
(pwdt_REPleaks_huLUC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huLUC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_REPleaks_huLUC3.csv"))
...
(pwdt_DaysToRepairAvgLU %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgLU) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_DaysToRepairAvgLU.csv"))
...
(pwdt_DaysToRepairAvgLUC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgLUC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_DaysToRepairAvgLUC1.csv"))
...
(pwdt_DaysToRepairAvgLUC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgLUC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_DaysToRepairAvgLUC2.csv"))
...
(pwdt_DaysToRepairAvgLUC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgLUC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_DaysToRepairAvgLUC3.csv"))
...
(pwdt_LeakAgeDaysAvgLU %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgLU) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_LeakAgeDaysAvgLU.csv"))
...
(pwdt_LeakAgeDaysAvgLUC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgLUC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_LeakAgeDaysAvgLUC1.csv"))
...
(pwdt_LeakAgeDaysAvgLUC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgLUC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_LeakAgeDaysAvgLUC2.csv"))
...
(pwdt_LeakAgeDaysAvgLUC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgLUC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/LU/pwdt_LeakAgeDaysAvgLUC3.csv"))
...
ppLeakDensityBG <- ma_blkgrps %>% 
  ...
  select(totalpopE, nhwhitepop_E, nhblackpop_E, hisppop_E, nhasianpop_E, 
         minority_E, eng_limitE, num2povE, lthsE, under5E, over64E,
         renter_occ_unitsE, total_occ_unitsE, householdsE, 
         MA_INCOME21, MA_MINORITY21, MA_ENGLISH, (starts_with("leaks_") & (ends_with("BG") | ends_with("BGC1") | ends_with("BGC2") | ends_with("BGC3"))), 
         (starts_with("AllLeaks") & (ends_with("BG") | ends_with("BGC1") | ends_with("BGC2") | ends_with("BGC3"))), 
         (starts_with("LeakAgeDaysAvg") & (ends_with("BG") | ends_with("BGC1") | ends_with("BGC2") | ends_with("BGC3"))),
         (starts_with("REPleaks_") & (ends_with("BG") | ends_with("BGC1") | ends_with("BGC2") | ends_with("BGC3"))), 
         (starts_with("DaystoRepairAvg") & (ends_with("BG") | ends_with("BGC1") | ends_with("BGC2") | ends_with("BGC3"))), 
...
(pwdt_leaks_sqkmBG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmBG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_sqkmBG.csv"))
...
(pwdt_leaks_sqkmBGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmBGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_sqkmBGC1.csv"))
...
(pwdt_leaks_sqkmBGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmBGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_sqkmBGC2.csv"))
...
(pwdt_leaks_sqkmBGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_sqkmBGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_sqkmBGC3.csv"))
...
(pwdt_REPleaks_sqkmBG %>% 
    filter(group2 == "totalpopE" | 
              (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmBG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_sqkmBG.csv"))
...
(pwdt_REPleaks_sqkmBGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmBGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_sqkmBGC1.csv"))
...
(pwdt_REPleaks_sqkmBGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmBGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_sqkmBGC2.csv"))
...
(pwdt_REPleaks_sqkmBGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_sqkmBGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_sqkmBGC3.csv"))
...
(pwdt_leaks_huBG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huBG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_huBG.csv"))
...
(pwdt_leaks_huBGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huBGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_huBGC1.csv"))
...
(pwdt_leaks_huBGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huBGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_huBGC2.csv"))
...
(pwdt_leaks_huBGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_leaks_huBGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_leaks_huBGC3.csv"))
...
(pwdt_REPleaks_huBG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huBG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_huBG.csv"))
...
(pwdt_REPleaks_huBGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huBGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_huBGC1.csv"))
...
(pwdt_REPleaks_huBGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huBGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_huBGC2.csv"))
...
(pwdt_REPleaks_huBGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_REPleaks_huBGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_REPleaks_huBGC3.csv"))
...
(pwdt_DaysToRepairAvgBG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgBG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_DaysToRepairAvgBG.csv"))
...
(pwdt_DaysToRepairAvgBGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgBGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_DaysToRepairAvgBGC1.csv"))
...
(pwdt_DaysToRepairAvgBGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgBGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_DaysToRepairAvgBGC2.csv"))
...
(pwdt_DaysToRepairAvgBGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_DaysToRepairAvgBGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_DaysToRepairAvgBGC3.csv"))
...
(pwdt_LeakAgeDaysAvgBG %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgBG) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_LeakAgeDaysAvgBG.csv"))
...
(pwdt_LeakAgeDaysAvgBGC1 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgBGC1) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_LeakAgeDaysAvgBGC1.csv"))
...
(pwdt_LeakAgeDaysAvgBGC2 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgBGC2) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_LeakAgeDaysAvgBGC2.csv"))
...
(pwdt_LeakAgeDaysAvgBGC3 %>% 
    filter(group2 == "totalpopE" | 
             (group2 == "under5E" & group1 == "totalpopE")) %>% 
    rbind(pwdt_OHU_LeakAgeDaysAvgBGC3) %>% 
    arrange(statistic) %>% 
    write_csv("Tables/BG/BG/pwdt_LeakAgeDaysAvgBGC3.csv"))
...
neighborsQC <- poly2nb(ma_blkgrps, queen = TRUE)
...
# compute Getis-Ord Gi statistic
local_g <- localG(ma_blkgrps$leaks_sqkm, listw)
...
# # create a table with exposure values and relative risks
# ppLeakDensity_df <- ppLeakDensityJoined %>% 
#   filter(!Group %in% c("Native American", "Other race", 
#                        "Native Pacific Islander", "Two or more races",
#                        "MA_MINORITY17", "MA_INCOME17")) %>% 
#   select(Group,
#          wLeaksPerSqKm,wLeaksPerSqKmC1,wLeaksPerSqKmC2,wLeaksPerSqKmC3,
#          wLeaksPerSqKmREP,wLeaksPerSqKmREPC1,wLeaksPerSqKmREPC2,wLeaksPerSqKmREPC3,
#          wLeaksPerSqKmALL,wLeaksPerSqKmALLC1,wLeaksPerSqKmALLC2,wLeaksPerSqKmALLC3) %>% 
#   mutate(wLeaksRR = case_when(Group == "Limited English HH" | 
#                           Group == "Total Households" ~ 
#                           wLeaksPerSqKm/wLeaksPerSqKm[Group == "Total Households"], 
#                         Group== "Renter Occupied HU" | 
#                           Group == "Total Occupied HU" ~ 
#                           wLeaksPerSqKm/wLeaksPerSqKm[Group == "Total Occupied HU"], 
#                         !Group %in% c("Limited English HH", "Renter Occupied HH",
#                                       "Total Households", "Total Occupied HU") ~ 
#                           wLeaksPerSqKm/wLeaksPerSqKm[Group == "Total Population"]),
#          wLeaksRRrepair = case_when(Group == "Limited English HH" | 
#                                       Group == "Total Households" ~ 
#                                       wLeaksPerSqKmREP/wLeaksPerSqKmREP[Group == "Total Households"], 
#                                     Group== "Renter Occupied HU" | 
#                                       Group == "Total Occupied HU" ~ 
#                                       wLeaksPerSqKmREP/wLeaksPerSqKmREP[Group == "Total Occupied HU"], 
#                                     !Group %in% c("Limited English HH", "Renter Occupied HH",
#                                                   "Total Households", "Total Occupied HU") ~ 
#                                       wLeaksPerSqKmREP/wLeaksPerSqKmREP[Group == "Total Population"]),
#          wLeaksRRtotal = case_when(Group == "Limited English HH" | 
#                                      Group == "Total Households" ~ 
#                                      wLeaksPerSqKmALL/wLeaksPerSqKmALL[Group == "Total Households"], 
#                                    Group== "Renter Occupied HU" | 
#                                      Group == "Total Occupied HU" ~ 
#                                      wLeaksPerSqKmALL/wLeaksPerSqKmALL[Group == "Total Occupied HU"], 
#                                    !Group %in% c("Limited English HH", "Renter Occupied HH",
#                                                  "Total Households", "Total Occupied HU") ~ 
#                                      wLeaksPerSqKmALL/wLeaksPerSqKmALL[Group == "Total Population"]),
         # Group = recode(Group, "MA_ENGLISH" = "MA Limited English HH",
         #                "MA_MINORITY21" = "MA Minority",
         #                "MA_INCOME21" = "MA Low Income")) %>%
...
#   labs(title = "Priority Populations and Unrepaired Gas Leaks in 2019\nacross Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.")
# 
...
#   labs(title = "Priority Populations and Unrepaired Gas Leaks\nPer Housing Unit in 2019 across Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.")
# 
...
#   labs(title = "Priority Populations and All Repaired and Unrepaired Gas Leaks\nin 2019 across Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.")
# 
...
#                         km^2, ")", " by Census Block Group",sep = ""))) +
#   theme_minimal() +
#   labs(title = "Priority Populations and Repaired Gas Leaks\nin 2019 across Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.") +
...
#   labs(title = "Priority Populations and Average Age of Unrepaired\nLeaks in 2019 across Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.")
# 
# ggsave("Images/LeaksPPage_blkgrp_moe.png")
# 
# 
...
#   labs(title = "Priority Populations and Average Leak Repair Times\nin 2019 across Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.")
# 
...
#   labs(title = "Priority Populations and Percentage of Leaks Repaired\nin 2019 across Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.")
# 
...
#        y = expression(paste("Population-weighted mean leak density (leaks/", 
#                             km^2, ")", " by Census Block Group",sep = "")),
#        title = "Priority Populations and Unrepaired Gas Leaks in 2019 across Massachusetts", caption = "Based on 5-year ACS 2015-19 estimates. Error bars are 90% confidence interval.")
# 
# ggsave("Images/LeaksPPbyClass_blkgrp.png")
...
# # library(weights)
# weights::wtd.t.test(x = ma_blkgrps$leaks_sqkm, y = ma_blkgrps$leaks_sqkm, 
#            weight = ma_blkgrps$nhwhitepop_E, 
#            weighty = ma_blkgrps$nhblackpop_E, 
#            bootse = TRUE, bootp = TRUE)
# 
# weights::wtd.t.test(x = ma_blkgrps$PctRepaired19, 
#                     y = ma_blkgrps$PctRepaired19, 
#            weight = ma_blkgrps$nhwhitepop_E, 
#            weighty = ma_blkgrps$eng_limitE, 
#            bootse = TRUE, bootp = TRUE)
