...
```{r histREP, fig.align='center', fig.cap="Histogram of age of leaks repaired in 2019 by leak class"}
...
```{r mapTimeBG, fig.align='center', fig.cap= "Average age for leaks repaired in 2019 across Massachusetts by Census Block Group", cache=TRUE}
...
```{r mapTimeTR, fig.align='center', fig.cap= "Average age for leaks repaired in 2019 across Massachusetts by Census Tract", cache=TRUE}
...
```{r magBGage, fig.align='center', fig.cap= "Average unrepaired leak age in 2019 across Massachusetts by Census Block Group", cache=TRUE}
...
```{r magTRage, fig.align='center', fig.cap= "Average unrepaired leak age in 2019 across Massachusetts by Census Tract", cache=TRUE}
# create a map of average leak age by block group
...
```{r magCOage, fig.align='center', fig.cap= "Average unrepaired leak age in 2019 across Massachusetts by municipality", cache=TRUE}
