...
ppLeakDensity_df_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Unrepaired Leaks Per Occupied Housing Unit in 2020 across Massachusetts", caption = "Colors indicate if exposure is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Environmental Justice communities ('MA') only evaluated\nat Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotGraphOHUallscalesRE2020.png")
...
repaired_Timedf %>% kable(., longtable = T, booktabs = T,
                          format.args = list(big.mark = ','),
                          caption = "Leak repair time (days), 2020", 
                          align = "r", 
                          digits = 1) %>% 
  # add_header_above(., c(" ", "Unrepaired Leaks" = 4, "Repaired Leaks" = 4, 
  #                       "Total Leaks" = 4)) %>% 
...
repaired2020 %>% 
  ...
  labs(title = "Leak Repair Times by Leak Class in 2020",
       x = "Days to Repair",
...
m4 <- tm_shape(ng_nogas_muni, bbox = ma_state_sf) + 
  ...
  tm_scale_bar(breaks = c(0,25,50), position = c("center","BOTTOM")) +
  tm_layout(legend.position = c("left","bottom"),
            title = "Massachusetts Mean Leak Repair Times by Census Block Group and Utility Territories, 2020",
            inner.margins = c(0.02,0.02,0.09,0.02)) +
  tm_credits("BG = Berkshire Gas\nBGC = Blackstone Gas Co.\nEG = Eversource Gas Co. of MA\nEV = Eversource Energy\nLU = Liberty Utilities\nNG = National Grid\nUN = Unitil/Fitchburg Gas", position = c(.3,.08), col = "gray47", size = 0.7)

tmap_save(m4, filename = "Images/pub/m_blkgrpTime2020.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_blkgrpTime2020.png")
...
m4 <- tm_shape(ng_nogas_muni, bbox = ma_state_sf) + 
  ...
  tm_scale_bar(breaks = c(0,25,50), position = c("center","BOTTOM")) +
  tm_layout(legend.position = c("left","bottom"),
            title = "Massachusetts Mean Leak Repair Times by Census Tract and Utility Territories, 2020",
            inner.margins = c(0.02,0.02,0.09,0.02)) +
  tm_credits("BG = Berkshire Gas\nBGC = Blackstone Gas Co.\nEG = Eversource Gas Co.of MA\nEV = Eversource Energy\nLU = Liberty Utilities\nNG = National Grid\nUN = Unitil/Fitchburg Gas", position = c(.3,.08), col = "gray47", size = 0.7)

tmap_save(m4, filename = "Images/pub/m_tractTime2020.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_tractTime2020.png")
...
m4 <- tm_shape(ng_nogas_muni, bbox = ma_state_sf) + 
  ...
  tm_scale_bar(breaks = c(0,25,50), position = c("center","BOTTOM")) +
  tm_layout(legend.position = c("left","bottom"),
            title = "Massachusetts Mean Leak Repair Times by Municipality and Utility Territories, 2020",
            inner.margins = c(0.02,0.02,0.09,0.02)) +
  tm_credits("BG = Berkshire Gas\nBGC = Blackstone Gas Co.\nEG = Eversource Gas Co. of MA\nEV = Eversource Energy\nLU = Liberty Utilities\nNG = National Grid\nUN = Unitil/Fitchburg Gas", position = c(.3,.08), col = "gray47", size = 0.7)

tmap_save(m4, filename = "Images/pub/m_cosubTime2020.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_cosubTime2020.png")
...
ppLeakDensity_df_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Mean Leak Repair Time in 2020 across Massachusetts", caption = "Colors indicate if repair time is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Environmental Justice communities ('MA') only evaluated\nat Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotGraphTimeallscalesRE2020.png")
...
repaired2020 %>% 
  ...
  ggtitle("Leak Repair Times (days) by Utility in 2020") +
  xlab("") + ylab("Days to repair through Dec 31, 2020") + 
  scale_y_continuous(labels = function(x) format(x, big.mark = ","))
# facet_wrap("Class", scales = "free")

ggsave(filename = "Images/pub/boxplotLeaksByUtilityTime2020.png")
...
ppLeakDensityJoinedU_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Average Leak Repair Time in 2020 across Massachusetts by Utility", caption = "Colors indicate if time is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Environmental Justice communities ('MA') only evaluated\nat Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotTimeUtilityRE2020.png")


# unrepaired age by class
unrepaired_Timedf <- unrepaired2020 %>% 
  as.data.frame() %>% 
...
unrepaired_Timedf %>% kable(., longtable = T, booktabs = T,
                            format.args = list(big.mark = ','),
                            caption = "Unrepaired gas leak age (days), 2020", 
                            align = "r", 
                            digits = 1) %>% 
  # add_header_above(., c(" ", "Unrepaired Leaks" = 4, "Repaired Leaks" = 4, 
  #                       "Total Leaks" = 4)) %>% 
...
unrepaired2020 %>% 
  ...
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0)) +
  labs(title = "Unrepaired Leak Age by Leak Class in 2020",
       x = "Age (days)",
...
m5 <- tm_shape(ng_nogas_muni, bbox = ma_state_sf) + 
  ...
  tm_scale_bar(breaks = c(0,25,50), position = c("center","BOTTOM")) +
  tm_layout(legend.position = c("left","bottom"),
            title = "Massachusetts Mean Age of Unrepaired Leaks by Census Block Group and Utility Territories, 2020",
            inner.margins = c(0.02,0.02,0.09,0.02)) +
  tm_credits("BG = Berkshire Gas\nBGC = Blackstone Gas Co.\nEG = Eversource Gas Co. of MA\nEV = Eversource Energy\nLU = Liberty Utilities\nNG = National Grid\nUN = Unitil/Fitchburg Gas", position = c(.3,.08), col = "gray47", size = 0.7)

tmap_save(m5, filename = "Images/pub/m_blkgrpAge2020.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_blkgrpAge2020.png")
...
m5 <- tm_shape(ng_nogas_muni, bbox = ma_state_sf) + 
  ...
  tm_scale_bar(breaks = c(0,25,50), position = c("center","BOTTOM")) +
  tm_layout(legend.position = c("left","bottom"),
            title = "Massachusetts Mean Age of Unrepaired Leaks by Census Tract and Utility Territories, 2020",
            inner.margins = c(0.02,0.02,0.09,0.02)) +
  tm_credits("BG = Berkshire Gas\nBGC = Blackstone Gas Co.\nEG = Eversource Gas Co. of MA\nEV = Eversource Energy\nLU = Liberty Utilities\nNG = National Grid\nUN = Unitil/Fitchburg Gas", position = c(.3,.08), col = "gray47", size = 0.7)

tmap_save(m5, filename = "Images/pub/m_tractAge2020.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_tractAge2020.png")
...
m5 <- tm_shape(ng_nogas_muni, bbox = ma_state_sf) + 
  ...
  tm_scale_bar(breaks = c(0,25,50), position = c("center","BOTTOM")) +
  tm_layout(legend.position = c("left","bottom"),
            title = "Massachusetts Mean Age of Unrepaired Leaks by Municipality and Utility Territories, 2020",
            inner.margins = c(0.02,0.02,0.09,0.02)) +
  tm_credits("BG = Berkshire Gas\nBGC = Blackstone Gas Co.\nEG = Eversource Gas Co. of MA\nEV = Eversource Energy\nLU = Liberty Utilities\nNG = National Grid\nUN = Unitil/Fitchburg Gas", position = c(.3,.08), col = "gray47", size = 0.7)

tmap_save(m5, filename = "Images/pub/m_cosubAge2020.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_cosubAge2020.png")
...
ppLeakDensity_df_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Mean Leak Age in 2020 across Massachusetts", caption = "Colors indicate if leak age is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Environmental Justice communities ('MA') only evaluated\nat Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotGraphAgeallscalesRE2020.png")
...
ppLeakDensityJoinedU_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Average Unrepaired Leak Age in 2020 across Massachusetts by Utility", caption = "Colors indicate if time is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Environmental Justice communities ('MA') only evaluated\nat Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotAgeUtilityRE2020.png")
