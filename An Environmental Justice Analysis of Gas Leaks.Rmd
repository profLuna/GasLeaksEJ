...
ppLeakDensity_df_bg <- readRDS("Data/ppLeakDensity_df_blkgrps.Rds")
ppLeakDensity_df_tr <- readRDS("Data/ppLeakDensity_df_tracts.Rds")
ppLeakDensity_df_co <- readRDS("Data/ppLeakDensity_df_cosubs.Rds")

ppLeakDensityJoinedU_bg <- readRDS("Data/ppLeakDensityJoinedU_BG.Rds")
ppLeakDensityJoinedU_tr <- readRDS("Data/ppLeakDensityJoinedU_Tract.Rds")
ppLeakDensityJoinedU_co <- readRDS("Data/ppLeakDensityJoinedU_Cosub.Rds")
```
...
```{r mapAllLeaks, fig.align='center'}
...
tmap_save(m_gridTotal, filename = "Images/m_gridTotalUtil.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_gridTotalUtil.png")
```
```{r mapAllLeaksBG, fig.align='center'}
...
tmap_save(m1, filename = "Images/m_blkgrpTotal.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_blkgrpTotal.png")
```
```{r mapAllLeaksTR, fig.align='center'}
...
tmap_save(m2, filename = "Images/m_tractTotal.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_tractTotal.png")
```
```{r mapAllLeaksCO, fig.align='center'}
...
tmap_save(m3, filename = "Images/m_cosubTotal.png", dpi = 600, height = 4, 
          width = 8, units = "in")

knitr::include_graphics("Images/m_cosubTotal.png")
```
...
ggsave("Images/DotGraphallscalesRE.png")
```
...
ggsave("Images/DotGraphallscalesUtilityRE.png")
```


### Statewide exposure normalized by occupied housing units

```{r mapOHUbg, fig.align='center'}
...
tmap_save(m1b, filename = "Images/m_blkgrpOHU.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_blkgrpOHU.png")
```

```{r mapOHUtr, fig.align='center'}
...
tmap_save(m2b, filename = "Images/m_tractOHU.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_tractOHU.png")
```

```{r mapOHUco, fig.align='center'}
# create map of leaks per OHU by Tract
...
tmap_save(m2b, filename = "Images/m_cosubOHU.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_cosubOHU.png")
```
...
ggsave("Images/DotGraphOHUallscalesRE.png")
```
...
ggsave("Images/DotGraphOHUallscalesUtilityRE.png")
```
...
ggsave("Images/histRepairTime.png")
```

```{r mapTimeBG, fig.align='center'}
...
tmap_save(m4, filename = "Images/m_blkgrpTime.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_blkgrpTime.png")
```

```{r mapTimeTR, fig.align='center'}
# create a map of average repair times by block group
...
tmap_save(m4, filename = "Images/m_tractTime.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_tractTime.png")
```

```{r mapTimeCO, fig.align='center'}
# create a map of average repair times by block group
...
tmap_save(m4, filename = "Images/m_cosubTime.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_cosubTime.png")
```
...
ggsave("Images/DotGraphTimeallscalesRE.png")
```
...
ggsave(filename = "Images/boxplotLeaksByUtilityTime.png")
```
...
ggsave("Images/DotTimeUtilityRE.png")
```
...
ggsave("Images/histAge.png")
```

```{r magBGage, fig.align='center'}
...
tmap_save(m5, filename = "Images/m_blkgrpAge.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_blkgrpAge.png")
```

```{r magTRage, fig.align='center'}
# create a map of average leak age by block group
...
tmap_save(m5, filename = "Images/m_tractAge.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_tractAge.png")
```

```{r magCOage, fig.align='center'}
...
tmap_save(m5, filename = "Images/m_cosubAge.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/m_cosubAge.png")
```
...
ggsave("Images/DotGraphAgeallscalesRE.png")
```
...
ggsave("Images/DotAgeUtilityRE.png")
```
