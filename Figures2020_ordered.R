...
ggsave("Images/pub/DotGraphOHUallscalesRE2020ordered.png")
...
ggsave("Images/pub/DotGraphOHUallscalesUtilityRE2020ordered.png")
...
ppLeakDensity_df_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Mean Leak Repair Time in 2020 across Massachusetts", caption = "Colors indicate if exposure is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Colors of horizontal bars through shapes indicate if exposure is consistently\nabove (orange) or below (blue), or if it is mixed (gray). Environmental Justice communities ('MA') only evaluated at Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotGraphTimeallscalesRE2020ordered.png")
...
ppLeakDensityJoinedU_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Average Leak Repair Time in 2020 across Massachusetts by Utility", caption = "Colors indicate if exposure is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Colors of horizontal bars through shapes indicate if exposure is consistently\nabove (orange) or below (blue), or if it is mixed (gray). Environmental Justice communities ('MA') only evaluated at Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotTimeUtilityRE2020ordered.png")
...
ppLeakDensity_df_all2 %>% 
  ...
  geom_linerange(data = ppLeakDensity_df_all,
                 aes(x = Group, y = med, ymin = min, ymax = max), size = 0.3) +
  # scale_y_continuous(limits = c(0.15,1.5)) +
  coord_flip() + 
  # scale_x_reordered() +
  theme_minimal(base_size = 6) +
  theme(legend.title=element_blank(), legend.position = "top",
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Mean Leak Age in 2020 across Massachusetts", caption = "Colors indicate if exposure is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Colors of horizontal bars through shapes indicate if exposure is consistently\nabove (orange) or below (blue), or if it is mixed (gray). Environmental Justice communities ('MA') only evaluated at Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotGraphAgeallscalesRE2020ordered.png")
...
ppLeakDensityJoinedU_all2 %>% 
  ...
  labs(x = NULL, 
       ...
       title = "Relative Exposure to Average Unrepaired Leak Age in 2020 across Massachusetts by Utility", caption = "Colors indicate if exposure is above (orange), below (blue), or equal to (gray) general population. Shapes indicate scale or unit of analysis. Colors of horizontal bars through shapes indicate if exposure is consistently\nabove (orange) or below (blue), or if it is mixed (gray). Environmental Justice communities ('MA') only evaluated at Block Group scale. Disabled Adults and Housing Burdened only evaluated at Tract and Municipality scales.")

ggsave("Images/pub/DotAgeUtilityRE2020ordered.png")
