...
unrepaired2020_with_tract <- ma_tracts %>% 
  select(GEOID) %>%
  st_join(unrepaired2020, ., largest = TRUE)
# do same for repaired leaks
repaired2020_with_tract <- ma_tracts %>% 
  select(GEOID) %>%
  st_join(repaired2020, ., largest = TRUE)

# break them out by leak class
unrepaired2020_with_tractC1 <- unrepaired2020_with_tract %>% 
  filter(Class == "1")

unrepaired2020_with_tractC2 <- unrepaired2020_with_tract %>% 
  filter(Class == "2")

unrepaired2020_with_tractC3 <- unrepaired2020_with_tract %>% 
  filter(Class == "3")
# do same for repaired
repaired2020_with_tractC1 <- repaired2020_with_tract %>% 
  filter(Class == "1")

repaired2020_with_tractC2 <- repaired2020_with_tract %>% 
  filter(Class == "2")

repaired2020_with_tractC3 <- repaired2020_with_tract %>% 
  filter(Class == "3")

# group by GEOID to get a simple count of all leaks within each tract, as well as avg leak age in days
unrepaired2020_by_tract <- unrepaired2020_with_tract %>% 
  group_by(GEOID) %>% 
  summarize(unrepaired2020total = n(),
            LeakAgeDaysAvg = mean(LeakAgeDays, na.rm = TRUE),
            LeakAgeDaysMed = median(LeakAgeDays, na.rm = TRUE))

unrepaired2020_by_tractC1 <- unrepaired2020_with_tractC1 %>% 
  group_by(GEOID) %>% 
...
unrepaired2020_by_tractC2 <- unrepaired2020_with_tractC2 %>% 
  group_by(GEOID) %>% 
...
unrepaired2020_by_tractC3 <- unrepaired2020_with_tractC3 %>% 
  group_by(GEOID) %>% 
...
repaired2020_by_tractC2 <- repaired2020_with_tractC2 %>% 
  group_by(GEOID) %>% 
...
repaired2020_by_tractC3 <- repaired2020_with_tractC3 %>% 
  group_by(GEOID) %>% 
...
unrepaired2020_by_utility <- unrepaired2020_with_tract %>% 
  as.data.frame() %>% 
...
unrepaired2020_by_utilityC1 <- unrepaired2020_with_tractC1 %>% 
  as.data.frame() %>% 
  group_by(Utility, GEOID) %>% 
...
unrepaired2020_by_utilityC2 <- unrepaired2020_with_tractC2 %>% 
  as.data.frame() %>% 
  group_by(Utility, GEOID) %>% 
...
unrepaired2020_by_utilityC3 <- unrepaired2020_with_tractC3 %>% 
  as.data.frame() %>% 
  group_by(Utility, GEOID) %>% 
...
repaired2020_by_utility <- repaired2020_with_tract %>% 
  as.data.frame() %>% 
  group_by(Utility, GEOID) %>% 
...
repaired2020_by_utilityC1 <- repaired2020_with_tractC1 %>% 
  as.data.frame() %>% 
  group_by(Utility, GEOID) %>% 
...
repaired2020_by_utilityC2 <- repaired2020_with_tractC2 %>% 
  as.data.frame() %>% 
  group_by(Utility, GEOID) %>% 
...
repaired2020_by_utilityC3 <- repaired2020_with_tractC3 %>% 
  as.data.frame() %>% 
  group_by(Utility, GEOID) %>% 
...
ma_tracts <- lapply(list(unrepaired2020_by_tract,
                            unrepaired2020_by_tractC1,
                            unrepaired2020_by_tractC2,
                            unrepaired2020_by_tractC3), function(x){
                              as.data.frame(x) %>% 
                                select(-geometry)}) %>% 
...
# join total leak counts to the tract demographics
ma_tracts <- lapply(list(repaired2020_by_tract,
                            repaired2020_by_tractC1,
                            repaired2020_by_tractC2,
                            repaired2020_by_tractC3), function(x){
                              as.data.frame(x) %>% 
                                select(-geometry)}) %>% 
  reduce(full_join, by = "GEOID") %>% 
  left_join(ma_tracts, ., by = "GEOID") %>% 
...
saveRDS(ma_tracts, file = "Data/ma_tracts2020.Rds")
...
saveRDS(ppLeakDensityJoined, file = "Data/ppLeakDensityTR2020.Rds")

# load data
ppLeakDensityJoined <- readRDS("Data/ppLeakDensityTR2020.Rds")
...
# save object
saveRDS(ppLeakDensity_df, file = "Data/ppLeakDensity_df_tracts2020.Rds")

# load object
ppLeakDensity_df <- readRDS("Data/ppLeakDensity_df_tracts2020.Rds")
...
# save output
saveRDS(ppLeakDensityJoinedU, file = "Data/ppLeakDensityJoinedU_TR2020.Rds")

# load data
ppLeakDensityJoinedU <- readRDS("Data/ppLeakDensityJoinedU_TR2020.Rds")
...
ggsave("Images/LeaksPPbyClassRR_tract2020.png")
...
ggsave("Images/LeaksPPbyClassREPRR_tract2020.png")
...
ggsave("Images/LeaksPPbyClassAllRR_tract2020.png")
...
ggsave("Images/LeaksPPbyClass_HU_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyClassREP_HU_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyClassAll_HU_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyClassTime_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyClassAge_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtilityRR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtility_HU_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtilityREP_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtilityREP_HU_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtilityAll_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtilityAll_HU_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtilityAge_RR_tract2020.png")
...
ggsave("Images/LeaksPPbyUtilityTime_RR_tract2020.png")
