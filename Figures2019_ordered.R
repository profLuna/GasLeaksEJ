...
tmap_save(m_gridTotal, filename = "Images/pub/m_gridTotalUtil2019.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_gridTotalUtil2019.png")
...
tmap_save(m1, filename = "Images/pub/m_blkgrpTotal2019.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_blkgrpTotal2019.png")
...
tmap_save(m2, filename = "Images/pub/m_tractTotal2019.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_tractTotal2019.png")
...
tmap_save(m3, filename = "Images/pub/m_cosubTotal2019.png", dpi = 600, height = 4, 
          width = 8, units = "in")

knitr::include_graphics("Images/pub/m_cosubTotal2019.png")
...
ggsave("Images/pub/LeaksbyUtility2019.png")
...
# save factor order for comparison in later years
save(group_orderBG, group_orderTR, group_orderCO, file = "Images/pub/factorOrder2019.Rds")
...
ppLeakDensity_df_bg2 <- ppLeakDensity_df_bg %>% 
  ...
  mutate(leakClass = recode(leakClass, "wLeaksRR" = "All Leaks",
         ...
         # Group = reorder_within(Group, group_orderBG4, leakClass),
         # Group = reorder_within(Group, temp4, leakClass),
         Status = case_when(
...
ppLeakDensity_df_tr2 <- ppLeakDensity_df_tr %>% 
  ...
  mutate(leakClass = recode(leakClass, "wLeaksRR" = "All Leaks",
         ...
         # Group = reorder_within(Group, group_orderTR4, leakClass),
         Status = case_when(
...
ppLeakDensity_df_co2 <- ppLeakDensity_df_co %>% 
  ...
  mutate(leakClass = recode(leakClass, "wLeaksRR" = "All Leaks",
         ...
         # Group = reorder_within(Group, group_orderCO4, leakClass),
         Status = case_when(
...
ggsave("Images/pub/DotGraphallscalesRE2019ordered.png")
...
ggsave("Images/pub/DotGraphallscalesUtilityRE2019ordered.png")
...
tmap_save(m1b, filename = "Images/pub/m_blkgrpOHU2019.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_blkgrpOHU2019.png")
...
tmap_save(m2b, filename = "Images/pub/m_tractOHU2019.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_tractOHU2019.png")
...
tmap_save(m2b, filename = "Images/pub/m_cosubOHU2019.png", 
          dpi = 600, height = 4, width = 8, units = "in")

knitr::include_graphics("Images/pub/m_cosubOHU2019.png")
...
ggsave("Images/pub/DotGraphOHUallscalesRE2019ordered.png")
...
ggsave("Images/pub/DotGraphOHUallscalesUtilityRE2019ordered.png")
...
ggsave("Images/pub/DotGraphTimeallscalesRE2019ordered.png")
...
ggsave("Images/pub/DotTimeUtilityRE2019ordered.png")
...
ggsave("Images/pub/DotGraphAgeallscalesRE2019ordered.png")
...
ggsave("Images/pub/DotAgeUtilityRE2019ordered.png")
