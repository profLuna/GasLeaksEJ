# Analysis of gas leaks for 2019 at block group level. Using 'cleaned data' supplied by Dominic Nicholas at HEET
...
saveRDS(ma_blkgrps, file = "Data/ma_blkgrps2019.Rds")
...
saveRDS(ppLeakDensityJoined, file = "Data/ppLeakDensityBG2019.Rds")

# load data
ppLeakDensityJoined <- readRDS("Data/ppLeakDensityBG2019.Rds")
...
# save object
saveRDS(ppLeakDensity_df, file = "Data/ppLeakDensity_df_blkgrps2019.Rds")

# load object
ppLeakDensity_df <- readRDS("Data/ppLeakDensity_df_blkgrps2019.Rds")
...
# save output
saveRDS(ppLeakDensityJoinedU, file = "Data/ppLeakDensityJoinedU_BG2019.Rds")
