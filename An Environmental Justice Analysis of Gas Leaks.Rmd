...
output: 
  bookdown::pdf_document2:
    bibliography: [EJbib.bib, GASbib.bib]
    keep_tex: yes
    toc: true
...
```{r mapAllLeaks, fig.align='center', fig.cap= "Massachusetts Gas Leaks and Utility Territories, 2019, aggregated by 1km hexagon tessellations"}
